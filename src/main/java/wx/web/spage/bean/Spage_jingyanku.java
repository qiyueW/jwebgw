...
public class Spage_jingyanku {
    ...
    public String getSpage_jingyanku_neirong() {
        return spage_jingyanku_neirong;
    }

    public void setSpage_jingyanku_neirong(String spage_jingyanku_neirong) {
        this.spage_jingyanku_neirong = spage_jingyanku_neirong;
    }
