...
<%    if (!pck.checkUserORAdmin("Y101_15_1A")) {
        return;
    }
%>
        ...
        <script type="text/javascript">
            $().ready(
                    function () {
                        ...
                        // 绑定FORM提交事件
                        $('#fanganfl_formID').submit(function () {
                            $btn = $("#myButton").button('loading');
                            $(this).ajaxSubmit(
                                    {dataType: "json",
                                        url: "${path_home}/cc/fangan/fanganfl/a/add.jw",
                                        success: function (
                                                result) {
        ...
        <div class="container">
            <div class="row">
                <div class="panel panel-default">
                    ...
                    <div id="fanganfl_divID" class="panel-body">
                        <form id="fanganfl_formID" method="post" class="form-horizontal">
                            <div class="form-group">
                                <label class="col-sm-4 control-label" for="fanganfl_pid2">上级分类</label>
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" name="fanganfl_pid2"id="fanganfl_pid2" required />
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-4 control-label" for="fanganfl_name">系列名称(50字内)</label>
                                <div class="col-sm-5">
                                    <input type="text" name="fanganfl_name" id="fanganfl_name" maxlength="50" />
                                </div>
                            </div>
                            <div class="form-group">
