 ...
 * @author:liwenjian
 * @version 1.0.0
 * 原网址地址 https://www.cnblogs.com/lyxy/p/5549941.html
 */
public class CheckMPC {
    /** Wap网关Via头信息中特有的描述信息 */
    private static final String mobileGateWayHeaders[] = new String[] { "ZXWAP", // 中兴提供的wap网关的via信息，例如：Via=ZXWAP
                                                                            // GateWayZTE
                                                                            // Technologies，
