...
//                    
                   ...
                   .setEmptyNode("Y101", "Y101_11", "模板中心", false)
                        .setHMAndViewNode("Y101_11", "Y101_11A", "通用模板分类添加","cc/cmodel/cmodelfl/cmodelfl_A.jsp", true)
                        .setViewNode("Y101_11", "Y101_11_0", "通用模板分类中心", "cc/cmodel/cmodelfl/cmodelfl.jsp", true)
                   ...
                   .setEmptyNode("Y101", "Y101_13", "bean数据中心", false)                
                    //Y1
                    .setHMAndViewNode("Y101_13", "Y101_3", "bean分类添加", "cc/mypackage/mypackage_A.jsp", true)
                    .setViewNode("Y101_13", "Y101_4", "bean分类维护", "cc/mypackage/mypackage.jsp", true)
                ...
                .setEmptyNode("Y101", "Y101_16", "数据预设", false)   
                    ...
                    .setViewNode("Y101_16", "Y101_16_2", "数据预设分类维护", "cc/yushizhi/yushizhifl/yushizhifl.jsp", true)
