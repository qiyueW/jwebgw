...
import wx.web.cc.hm.cache.MyPackageCache;
...
public class MyPackageSelect {
    ...
    public static void select(JWeb jw) {
        jw.printOne(wx.web.cc.hm.cache.MyPackageCache.CACHE.getCacheData(MyPackageCache.class).getJSON());
    }

//    @GG
    @M("/selectVast/GRID")
    public static void selectUI(JWeb jw) {//_UIGrid
        jw.printOne(wx.web.cc.hm.cache.MyPackageCache.CACHE.getCacheData(MyPackageCache.class).getLigeruiJSON());
    }
}
