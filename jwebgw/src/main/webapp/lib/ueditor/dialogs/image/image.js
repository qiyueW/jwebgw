...
//    var imyurl="/imy2lib/";
    ...
    OnlineImage.prototype = {
        ...
        pushData: function (list) {
            var i, item, img, icon, _this = this,listurl,
            ...
            for (i = 0; i < list.length; i++) {
                ...
                if (list[i] && list[i].url) {
                    ...
                    img.width = 113;
                    img.setAttribute('src', urlPrefix + listurl + (listurl.indexOf('?') == -1 ? '?noCache=' : '&noCache=') + (+new Date()).toString(36));
                    img.setAttribute('_src', urlPrefix + listurl);
