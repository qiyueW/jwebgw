...
<%    if (!pck.checkUserORAdmin("Y100_2")) {
        return;
    }
%>
<!DOCTYPE html>
<html>
    <head>
        ...
        <script type="text/javascript" src="${path_home}/spage/js/jingyanku_A.js"></script>
        <script type="text/javascript">
            $(function () {
                ...
                }, "jingyankufl_id", "jingyankufl_pid", "jingyankufl_name")
    ...
    <body>
        ...
        <div style="position: relative;">
            <table>
                <tr>
                    <td>*标题</td><td><input type="text"  name="spage_jingyanku_biaoti" id="spage_jingyanku_biaoti"/></td>
                    <td>发布时间</td><td><input type="text" name="spage_jingyanku_fabushijian"id="spage_jingyanku_fabushijian"/></td>
                </tr>
                <tr>
                    <td>*关键词</td>
                    <td>
                        <input type="text"  name="spage_jingyanku_gjc" id="spage_jingyanku_gjc"/>
                    </td>
                    <td>*分类归档</td>
                    <td>
            ...
            <div>内容明细</div>
            <script type="text/plain" id="spage_jingyanku_neirong"  name="spage_jingyanku_neirong"></script>
        </div>
    </body>
</html>
