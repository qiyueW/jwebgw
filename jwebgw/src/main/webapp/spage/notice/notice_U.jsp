...
<html>
    <head>
        ...
        <script type="text/javascript" src="${path_home}/spage/js/notice_U.js"></script>
                ...
                <div class="panel panel-default">
                    ...
                    <div id="series_divID" class="panel-body">
                        <form id="spage_formID" method="post" class="form-horizontal">
                            <input type="hidden"name="spage_notice_zj" id="spage_notice_zj" value="${obj.spage_notice_zj}"/>
                            <div class="form-group">
                                <table>
                                    <tr>
                                        <td>*标题</td><td><input type="text"  name="spage_notice_biaoti" id="spage_notice_biaoti" value="${obj.spage_notice_biaoti}"/></td>
                                        <td>，*发布时间</td><td><input type="text" name="spage_notice_fabushijian"id="spage_notice_fabushijian" value="${obj.spage_notice_fabushijian}"/></td>
                                    </tr>
                                </table>
                            </div >
                            <div class="form-group">
                                <div>内容明细</div>
                                <script type="text/plain" id="spage_notice_neirong"  name="spage_notice_neirong">${obj.spage_notice_neirong}</script>
                            </div>
                            <div class="form-group">
