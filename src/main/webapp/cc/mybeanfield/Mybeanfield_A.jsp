...
<html>
    <head>
        ...
        <script type="text/javascript">
            ...
            $(function () {
                ...
                var beanfl = new ztree_select("${path_home}/cc/mypackage/s/selectVast.jw", {}, "showmybeanTree", "mybean_mc", "mybean_zj", 220, 390);
    ...
    <body>
        ...
        <table>
            ...
            <tr>
                <td>bean</td><td> <div id="showmybeanTree"  style=" position: relative;z-index:1000"></div></td>
            </tr>
            <tr>
