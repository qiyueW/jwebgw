        ...
        <script type="text/javascript">
            ...
            $(function ()
            {
                ...
                $("#tree1").ligerTree({
                    ...
                    url: '${path_home}/sys/admin/manager/v/showMenu.jw',
                    checkbox: false,
                    slide: false,
                    nodeWidth: 120,
//                    idFieldName: 'id', 
    ...
    <body style="padding:0px;background:#EAEEF5;">  
        ...
        <div id="topmenu" style="height:15px;">
            <div style="height:32px; line-height:32px; text-align:center;">
                ...
                &nbsp;&nbsp;&nbsp;
                <a href="${path_home}/sys/admin/manager/loginOut.jw">退出登陆</a>
            </div>
        </div>
        <script>
            function updateMypassword() {
                $.ligerDialog.open({title: '修改密码', url: '${path_home}/admin/usersafe/adminUserSelf.jsp', height: 500, width: 600, isResize: true});
            }
        </script>
    </body>
</html>
