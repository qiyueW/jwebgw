...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="lib/ueditor/dialogs/video/video.css" />
    </head>
    <body>
        <div class="wrapper">
            <div id="videoTab">
        ...
        <!-- webuploader -->
        <script type="text/javascript" src="lib/ueditor/third-party/webuploader/webuploader.min.js"></script>
        <link rel="stylesheet" type="text/css" href="lib/ueditor/third-party/webuploader/webuploader.css"/>
        <!-- video -->
        <script type="text/javascript" src="lib/ueditor/dialogs/video/video.js"></script>
    </body>
</html>
